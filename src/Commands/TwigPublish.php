<?php namespace Raizdev\Twig\Commands;
...
class TwigPublish extends BaseCommand
{
    ...
    /**
     * The path to Raizdev\Twig\src directory.
     *
     * @var string
     */
    ...
    protected function publishConfig()
    {
        ...
        $content = str_replace('namespace Raizdev\Twig\Config', "namespace Config", $content);
        $content = str_replace('extends BaseConfig', "extends \Raizdev\Twig\Config\Twig", $content);
